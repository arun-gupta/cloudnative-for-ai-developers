# Pain 4 example: Multi-node training with PyTorchJob

A working demonstration of [Pain 4: Multi-node training keeps falling over](../../pains/04-multi-node-training.md). Same distributed training simulation, two submission styles. The Kubernetes manifests are the only thing that changes.
